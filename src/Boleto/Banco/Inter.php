...
class Inter extends AbstractBoleto implements BoletoAPIContract
{
    ...
    public function toAPI()
    {
        ...
        return array_filter([
            ...
            'cnpjCPFBeneficiario' => Util::documentoCnab($this->getBeneficiario()->getDocumento(), 14),
            ...
            'mora'                => $mora,
            'pagador'             => [
                'tipoPessoa' => Util::isDocumentoJuridico($this->getPagador()->getDocumento()) ? 'JURIDICA' : 'FISICA',
                ...
                'cnpjCpf'    => Util::normalizeDocumento($this->getPagador()->getDocumento()),
            ],
        ]);
    }
