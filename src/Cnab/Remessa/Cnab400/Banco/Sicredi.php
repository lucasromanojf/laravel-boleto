...
class Sicredi extends AbstractRemessa implements RemessaContract
{
    ...
    protected function header()
    {
        ...
        $this->add(32, 45, Util::documentoCnab($this->getBeneficiario()->getDocumento(), 14));
        $this->add(46, 76, '');
    ...
    public function addBoleto(BoletoContract $boleto)
    {
        ...
        $this->add(219, 220, Util::isDocumentoJuridico($boleto->getPagador()->getDocumento()) ? '20' : '10');
        ...
        $this->add(340, 353, $boleto->getSacadorAvalista() ? Util::documentoCnab($boleto->getSacadorAvalista()->getDocumento(), 14) : Util::formatCnab('X', '', 14));
